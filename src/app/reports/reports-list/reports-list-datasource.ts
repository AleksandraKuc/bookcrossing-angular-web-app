 ...
 */
export class ReportsListDataSource extends DataSource<ReportDefinition> {
   ...
   */
  private getPagedData(data: ReportDefinition[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: ReportDefinition[]) {
